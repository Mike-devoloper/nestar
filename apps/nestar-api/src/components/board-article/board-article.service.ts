...
export class BoardArticleService {
    ...
    public async createBoardArticle(memberId: ObjectId, input: BoardArticleInput):Promise<BoardArticle> {
        ...
        try {
            ...
            console.log("Error on CreateArticleService", err);
            throw new BadRequestException(Message.CREATE_FAILED)
        }
    }   


    public async getBoardArticle(memberId, articleId):Promise<BoardArticle>{
        const search: T = {
            _id: articleId,
    ...
    public async boardArticleStatsEditor(input: StatisticModifier):Promise<BoardArticle>{
        ...
        return await this.boardArticleModel.findByIdAndUpdate(_id, {$inc: {[targetKey]: modifier}}, {new: true}).exec()
    }
}
